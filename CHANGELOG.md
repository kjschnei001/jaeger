...
* Support secure OTLP exporter config for hotrod ([@graphaelli](https://github.com/graphaelli) in [#4231](https://github.com/kjschnei001/jaeger/pull/4231))
...
* Bump OTEL dependencies => v0.60.0 and grpc => v1.49.0 ([@yurishkuro](https://github.com/yurishkuro) in [#3928](https://github.com/kjschnei001/jaeger/pull/3928))
...
* Close #3270: Prevent rollover lookback from passing the Unix epoch ([#3299](https://github.com/kjschnei001/jaeger/pull/3299), [@ctreatma](https://github.com/ctreatma))
...
* Add partial retry capability to OTEL ES exporter. ([#2456](https://github.com/kjschnei001/jaeger/pull/2456), [@pavolloffay](https://github.com/pavolloffay))
...
Revert UI back to 1.9 due to a bug https://github.com/kjschnei001/jaeger-ui/issues/628
...
* Mask passwords when written as json ([#2302](https://github.com/kjschnei001/jaeger/pull/2302), [@objectiser](https://github.com/objectiser))
...
* Clean-up collector handlers builder ([#1991](https://github.com/kjschnei001/jaeger/pull/1991), [@yurishkuro](https://github.com/yurishkuro))
...
* UI pinned to version 1.5.0. The changelog is available here [v1.5.0](https://github.com/kjschnei001/jaeger-ui/blob/main/CHANGELOG.md#v150-november-4-2019)
...
* Passthrough OAuth bearer token supplied to Query service through to ES storage ([#1599](https://github.com/kjschnei001/jaeger/pull/1599), [@rubenvp8510](https://github.com/rubenvp8510))
* Kafka kerberos authentication support for collector/ingester ([#1589](https://github.com/kjschnei001/jaeger/pull/1589), [@rubenvp8510](https://github.com/rubenvp8510))
* Allow Cassandra schema builder to use credentials ([#1635](https://github.com/kjschnei001/jaeger/pull/1635), [@PS-EGHornbostel](https://github.com/PS-EGHornbostel))
* Add docs generation command ([#1572](https://github.com/kjschnei001/jaeger/pull/1572), [@pavolloffay](https://github.com/pavolloffay))

##### Bug fixes, Minor Improvements

* Fix data race between `Agent.Run()` and `Agent.Stop()` ([#1625](https://github.com/kjschnei001/jaeger/pull/1625), [@tigrannajaryan](https://github.com/tigrannajaryan))
* Use json number when unmarshalling data from ES ([#1618](https://github.com/kjschnei001/jaeger/pull/1618), [@pavolloffay](https://github.com/pavolloffay))
* Define logs as nested data type ([#1622](https://github.com/kjschnei001/jaeger/pull/1622), [@pavolloffay](https://github.com/pavolloffay))
* Fix archive storage not querying old spans older than maxSpanAge ([#1617](https://github.com/kjschnei001/jaeger/pull/1617), [@pavolloffay](https://github.com/pavolloffay))
* Query service: fix logging errors on SIGINT ([#1601](https://github.com/kjschnei001/jaeger/pull/1601), [@jan25](https://github.com/jan25))
* Direct grpc logs to Zap logger ([#1606](https://github.com/kjschnei001/jaeger/pull/1606), [@yurishkuro](https://github.com/yurishkuro))
* Fix sending status to health check channel in Query service ([#1598](https://github.com/kjschnei001/jaeger/pull/1598), [@jan25](https://github.com/jan25))
* Add tmp-volume to all-in-one image to fix badger storage ([#1571](https://github.com/kjschnei001/jaeger/pull/1571), [@burmanm](https://github.com/burmanm))
* Do not fail es-cleaner if there are no jaeger indices ([#1569](https://github.com/kjschnei001/jaeger/pull/1569), [@pavolloffay](https://github.com/pavolloffay))
* Automatically set `GOMAXPROCS` ([#1560](https://github.com/kjschnei001/jaeger/pull/1560), [@rubenvp8510](https://github.com/rubenvp8510))
* Add CA certs to all-in-one image ([#1554](https://github.com/kjschnei001/jaeger/pull/1554), [@chandresh-pancholi](https://github.com/chandresh-pancholi))

#### UI Changes

* UI pinned to version 1.3.0. The changelog is available here [v1.3.0](https://github.com/kjschnei001/jaeger-ui/blob/main/CHANGELOG.md#v130-june-21-2019)
...
##### ⛔ Breaking Changes
- The `kafka` flags were removed in favor of `kafka.producer` and `kafka.consumer` flags ([#1424](https://github.com/kjschnei001/jaeger/pull/1424), [@ledor473](https://github.com/ledor473))
...
* Add Admin port and group all ports in one file ([#1442](https://github.com/kjschnei001/jaeger/pull/1442), [@yurishkuro](https://github.com/yurishkuro))

    This change fixes issues [#1428](https://github.com/kjschnei001/jaeger/issues/1428), [#1332](https://github.com/kjschnei001/jaeger/issues/1332) and moves all metrics endpoints from API ports to **admin ports**. It requires re-configuring Prometheus scraping rules. Each Jaeger binary has its own admin port that can be found under `--admin-http-port` command line flag by running the `${binary} help` command.

##### New Features

* Add gRPC resolver using external discovery service ([#1498](https://github.com/kjschnei001/jaeger/pull/1498), [@guanw](https://github.com/guanw))
* gRPC storage plugin framework ([#1461](https://github.com/kjschnei001/jaeger/pull/1461), [@chvck](https://github.com/chvck))
* Supports customized kafka client id ([#1507](https://github.com/kjschnei001/jaeger/pull/1507), [@newly12](https://github.com/newly12))
* Support gRPC for query service ([#1307](https://github.com/kjschnei001/jaeger/pull/1307), [@annanay25](https://github.com/annanay25))
* Expose tls.InsecureSkipVerify to es.tls.* CLI flags ([#1473](https://github.com/kjschnei001/jaeger/pull/1473), [@stefanvassilev](https://github.com/stefanvassilev))
* Return info msg for `/health` endpoint ([#1465](https://github.com/kjschnei001/jaeger/pull/1465), [@stefanvassilev](https://github.com/stefanvassilev))
* Add pprof endpoint to admin endpoint ([#1375](https://github.com/kjschnei001/jaeger/pull/1375), [@konradgaluszka](https://github.com/konradgaluszka))
* Add inbound transport as label to collector metrics [#1446](https://github.com/kjschnei001/jaeger/pull/1446) ([guanw](https://github.com/guanw))
* Sorted key/value store `badger` backed storage plugin ([#760](https://github.com/kjschnei001/jaeger/pull/760), [@burmanm](https://github.com/burmanm))
* Add Admin port and group all ports in one file ([#1442](https://github.com/kjschnei001/jaeger/pull/1442), [@yurishkuro](https://github.com/yurishkuro))
* Adds support for agent level tag ([#1396](https://github.com/kjschnei001/jaeger/pull/1396), [@annanay25](https://github.com/annanay25))
* Add a Downsampling writer that drop a percentage of spans ([#1353](https://github.com/kjschnei001/jaeger/pull/1353), [@guanw](https://github.com/guanw))

##### Bug fixes, Minor Improvements

* Sort traces in memory store to return most recent traces ([#1394](https://github.com/kjschnei001/jaeger/pull/1394), [@jacobmarble](https://github.com/jacobmarble))
* Add span format tag for jaeger-collector ([#1493](https://github.com/kjschnei001/jaeger/pull/1493), [@guo0693](https://github.com/guo0693))
* Upgrade gRPC to 1.20.1 ([#1492](https://github.com/kjschnei001/jaeger/pull/1492), [@guanw](https://github.com/guanw))
* Switch from counter to a gauge for partitions held ([#1485](https://github.com/kjschnei001/jaeger/pull/1485), [@bobrik](https://github.com/bobrik))
* Add CORS handling for Zipkin collector service ([#1463](https://github.com/kjschnei001/jaeger/pull/1463), [@JonasVerhofste](https://github.com/JonasVerhofste))
* Check elasticsearch nil response ([#1467](https://github.com/kjschnei001/jaeger/pull/1467), [@YEXINGZHE54](https://github.com/YEXINGZHE54))
* Disable sampling in logger - `zap`([#1460](https://github.com/kjschnei001/jaeger/pull/1460), [@psinghal20](https://github.com/psinghal20))
* New layout for proto definitions and generated files ([#1427](https://github.com/kjschnei001/jaeger/pull/1427), [@annanay25](https://github.com/annanay25))
* Upgrade Go to 1.12.1 ([#1437](https://github.com/kjschnei001/jaeger/pull/1437) ,[@yurishkuro](https://github.com/yurishkuro))

#### UI Changes

* UI pinned to version 1.2.0. The changelog is available here [v1.2.0](https://github.com/kjschnei001/jaeger-ui/blob/main/CHANGELOG.md#v120-may-14-2019)
...
##### ⛔ Breaking Changes
- Introduce `kafka.producer` and `kafka.consumer` flags to replace `kafka` flags ([#1360](https://github.com/kjschnei001/jaeger/pull/1360), [@ledor473](https://github.com/ledor473))
...
- Support secure gRPC channel between agent and collector ([#1391](https://github.com/kjschnei001/jaeger/pull/1391), [@ghouscht](https://github.com/ghouscht), [@yurishkuro](https://github.com/yurishkuro))
- Allow to use TLS with ES basic auth ([#1388](https://github.com/kjschnei001/jaeger/pull/1388), [@pavolloffay](https://github.com/pavolloffay))

##### Bug fixes, Minor Improvements

- Make `esRollover.py init` idempotent ([#1407](https://github.com/kjschnei001/jaeger/pull/1407) and [#1408](https://github.com/kjschnei001/jaeger/pull/1408), [@pavolloffay](https://github.com/pavolloffay))
- Allow thrift reporter if grpc hosts are not provided ([#1400](https://github.com/kjschnei001/jaeger/pull/1400), [@pavolloffay](https://github.com/pavolloffay))
- Deprecate colon in index prefix in ES dependency store ([#1386](https://github.com/kjschnei001/jaeger/pull/1386), [@pavolloffay](https://github.com/pavolloffay))
- Make grpc reporter default and add retry ([#1384](https://github.com/kjschnei001/jaeger/pull/1384), [@pavolloffay](https://github.com/pavolloffay))
- Use `CQLSH_HOST` in final call to `cqlsh` ([#1372](https://github.com/kjschnei001/jaeger/pull/1372), [@funny-falcon](https://github.com/funny-falcon))

#### UI Changes

* UI pinned to version 1.1.0. The changelog is available here [v1.1.0](https://github.com/kjschnei001/jaeger-ui/blob/main/CHANGELOG.md#v110-march-3-2019)
...
- Discover dependencies table version automatically ([#1364](https://github.com/kjschnei001/jaeger/pull/1364), [@black-adder](https://github.com/black-adder))

##### Bug fixes, Minor Improvements

- Separate query-service functionality from http handler ([#1312](https://github.com/kjschnei001/jaeger/pull/1312), [@annanay25](https://github.com/annanay25))
...
- Remove cassandra SASI indices ([#1328](https://github.com/kjschnei001/jaeger/pull/1328), [@black-adder](https://github.com/black-adder))
...
- Remove `ErrorBusy`, it essentially duplicates `SpansDropped` ([#1091](https://github.com/kjschnei001/jaeger/pull/1091), [@cstyan](https://github.com/cstyan))

##### New Features

- Support certificates in elasticsearch scripts ([#1339](https://github.com/kjschnei001/jaeger/pull/1399), [@pavolloffay](https://github.com/pavolloffay))
- Add ES Rollover support to main indices ([#1309](https://github.com/kjschnei001/jaeger/pull/1309), [@pavolloffay](https://github.com/pavolloffay))
- Load ES auth token from file ([#1319](https://github.com/kjschnei001/jaeger/pull/1319), [@pavolloffay](https://github.com/pavolloffay))
- Add username/password authentication to ES index cleaner ([#1318](https://github.com/kjschnei001/jaeger/pull/1318), [@gregoryfranklin](https://github.com/gregoryfranklin))
- Add implementation of FindTraceIDs function for Elasticsearch reader ([#1280](https://github.com/kjschnei001/jaeger/pull/1280), [@vlamug](https://github.com/vlamug))
- Support archive traces for ES storage ([#1197](https://github.com/kjschnei001/jaeger/pull/1197), [@pavolloffay](https://github.com/pavolloffay))

##### Bug fixes, Minor Improvements

- Use Zipkin annotations if the timestamp is zero ([#1341](https://github.com/kjschnei001/jaeger/pull/1341), [@geobeau](https://github.com/geobeau))
- Use GRPC round robin balancing even if only one hostname ([#1329](https://github.com/kjschnei001/jaeger/pull/1329), [@benley](https://github.com/benley))
- Tolerate whitespaces in ES servers and kafka brokers ([#1305](https://github.com/kjschnei001/jaeger/pull/1305), [@verma-varsha](https://github.com/verma-varsha))
- Let cassandra servers contain whitespace in config ([#1301](https://github.com/kjschnei001/jaeger/pull/1301), [@karlpokus](https://github.com/karlpokus))
...
- Change Elasticsearch index prefix from `:` to `-` ([#1284](https://github.com/kjschnei001/jaeger/pull/1284), [@pavolloffay](https://github.com/pavolloffay))
...
- Add CLI configurable `es.max-num-spans` while retrieving spans from ES ([#1283](https://github.com/kjschnei001/jaeger/pull/1283), [@annanay25](https://github.com/annanay25))

The default value is set to 10000. Before no limit was applied.


- Update to jaeger-lib 2 and latest sha for jaeger-client-go, to pick up refactored metric names ([#1282](https://github.com/kjschnei001/jaeger/pull/1282), [@objectiser](https://github.com/objectiser))
...
- Add gRPC metrics to agent ([#1180](https://github.com/kjschnei001/jaeger/pull/1180), [@pavolloffay](https://github.com/pavolloffay))
...
- Rename tcollector proxy metric in agent ([#1182](https://github.com/kjschnei001/jaeger/pull/1182), [@pavolloffay](https://github.com/pavolloffay))
...
- Add tracegen utility for generating traces ([#1245](https://github.com/kjschnei001/jaeger/pull/1245), [@yurishkuro](https://github.com/yurishkuro))
- Use DCAwareRoundRobinPolicy as fallback for TokenAwarePolicy ([#1285](https://github.com/kjschnei001/jaeger/pull/1285), [@vprithvi](https://github.com/vprithvi))
- Add Zipkin Thrift as kafka ingestion format ([#1256](https://github.com/kjschnei001/jaeger/pull/1256), [@geobeau](https://github.com/geobeau))
- Add `FindTraceID` to the spanstore interface ([#1246](https://github.com/kjschnei001/jaeger/pull/1246), [@vprithvi](https://github.com/vprithvi))
- Migrate from glide to dep ([#1240](https://github.com/kjschnei001/jaeger/pull/1240), [@isaachier](https://github.com/isaachier))
- Make tchannel timeout for reporting in agent configurable ([#1034](https://github.com/kjschnei001/jaeger/pull/1034), [@gouthamve](https://github.com/gouthamve))
- Add archive traces to all-in-one ([#1189](https://github.com/kjschnei001/jaeger/pull/1189), [@pavolloffay](https://github.com/pavolloffay))
- Start moving components of adaptive sampling to OSS ([#973](https://github.com/kjschnei001/jaeger/pull/973), [@black-adder](https://github.com/black-adder))
- Add gRPC communication between agent and collector ([#1165](https://github.com/kjschnei001/jaeger/pull/1165), [#1187](https://github.com/kjschnei001/jaeger/pull/1187), [#1181](https://github.com/kjschnei001/jaeger/pull/1181) and [#1180](https://github.com/kjschnei001/jaeger/pull/1180), [@pavolloffay](https://github.com/pavolloffay))

##### Bug fixes, Minor Improvements

- Update exposed ports in ingester dockerfile ([#1289](https://github.com/kjschnei001/jaeger/pull/1289), [@objectiser](https://github.com/objectiser))
- Upgrade Shopify/Sarama for proper handling newest kafka servers 2.x by ingester ([#1248](https://github.com/kjschnei001/jaeger/pull/1248), [@vprithvi](https://github.com/vprithvi))
- Fix sampling strategies overwriting service entry when no sampling type is specified ([#1244](https://github.com/kjschnei001/jaeger/pull/1244), [@objectiser](https://github.com/objectiser))
- Fix dot replacement for int ([#1272](https://github.com/kjschnei001/jaeger/pull/1272), [@pavolloffay](https://github.com/pavolloffay))
- Add C* query to error logs ([#1250](https://github.com/kjschnei001/jaeger/pull/1250), [@vprithvi](https://github.com/vprithvi))
- Add locking around partitionIDToState map accesses ([#1239](https://github.com/kjschnei001/jaeger/pull/1239), [@vprithvi](https://github.com/vprithvi))
- Reorganize config manager packages in agent ([#1198](https://github.com/kjschnei001/jaeger/pull/1198), [@pavolloffay](https://github.com/pavolloffay))

#### UI Changes

* UI pinned to version 1.0.0. The changelog is available here [v1.0.0](https://github.com/kjschnei001/jaeger-ui/blob/main/CHANGELOG.md#v100-january-18-2019)
...
- Embedded components (SearchTraces and Tracepage) ([#263](https://github.com/kjschnei001/jaeger/pull/263), [@aljesusg](https://github.com/aljesusg))

##### Bug fixes, Minor Improvements

- Fix link in scatter plot when embed mode ([#283](https://github.com/kjschnei001/jaeger-ui/pull/283), [@aljesusg](https://github.com/aljesusg))
- Fix rendering X axis in TraceResultsScatterPlot - pass milliseconds to moment.js ([#274](https://github.com/kjschnei001/jaeger-ui/pull/274), [@istrel](https://github.com/istrel))
...
- Make agent timeout for reporting configurable and fix flags overriding ([#1034](https://github.com/kjschnei001/jaeger/pull/1034), [@gouthamve](https://github.com/gouthamve))
- Fix metrics handler registration in agent ([#1178](https://github.com/kjschnei001/jaeger/pull/1178), [@pavolloffay](https://github.com/pavolloffay))
...
- Refactor agent configuration ([#1092](https://github.com/kjschnei001/jaeger/pull/1092), [@pavolloffay](https://github.com/pavolloffay))
...
- Various changes around metrics produced by jaeger-query: Names scoped to the query component, generated for all span readers (not just ES), consolidate query metrics and include result tag ([#1074](https://github.com/kjschnei001/jaeger/pull/1074), [#1075](https://github.com/kjschnei001/jaeger/pull/1075) and [#1096](https://github.com/kjschnei001/jaeger/pull/1096), [@objectiser](https://github.com/objectiser))
...
- Configurable deadlock detector interval for ingester ([#1134](https://github.com/kjschnei001/jaeger/pull/1134), [@marqc](https://github.com/marqc))
- Emit spans for elastic storage backend ([#1128](https://github.com/kjschnei001/jaeger/pull/1128), [@annanay25](https://github.com/annanay25))
- Allow to use TLS certificates for Elasticsearch authentication ([#1139](https://github.com/kjschnei001/jaeger/pull/1139), [@clyang82](https://github.com/clyang82))
- Add ingester metrics, healthcheck and rename Kafka cli flags ([#1094](https://github.com/kjschnei001/jaeger/pull/1094), [@ledor473](https://github.com/ledor473))
- Add a metric for number of partitions held ([#1154](https://github.com/kjschnei001/jaeger/pull/1154), [@vprithvi](https://github.com/vprithvi))
- Log jaeger-collector tchannel port ([#1136](https://github.com/kjschnei001/jaeger/pull/1136), [@mindaugasrukas](https://github.com/mindaugasrukas))
- Support tracer env based initialization in hotrod ([#1115](https://github.com/kjschnei001/jaeger/pull/1115), [@eundoosong](https://github.com/eundoosong))
- Publish ingester as binaries and docker image ([#1086](https://github.com/kjschnei001/jaeger/pull/1086), [@ledor473](https://github.com/ledor473))
- Use Go 1.11 ([#1104](https://github.com/kjschnei001/jaeger/pull/1104), [@isaachier](https://github.com/isaachier))
- Tag images with commit SHA and publish to `-snapshot` repository ([#1082](https://github.com/kjschnei001/jaeger/pull/1082), [@pavolloffay](https://github.com/pavolloffay))

##### Bug fixes, Minor Improvements

- Fix child span context while tracing cassandra queries ([#1131](https://github.com/kjschnei001/jaeger/pull/1131), [@annanay25](https://github.com/annanay25))
- Deadlock detector hack for Kafka driver instability ([#1087](https://github.com/kjschnei001/jaeger/pull/1087), [@vprithvi](https://github.com/vprithvi))
- Fix processor overriding data in a buffer ([#1099](https://github.com/kjschnei001/jaeger/pull/1099), [@pavolloffay](https://github.com/pavolloffay))

#### UI Changes

##### New Features

- Span Search - Highlight search results ([#238](https://github.com/kjschnei001/jaeger-ui/pull/238)), [@davit-y](https://github.com/davit-y)
- Span Search - Improve search logic ([#237](https://github.com/kjschnei001/jaeger-ui/pull/237)),  [@davit-y](https://github.com/davit-y)
- Span Search - Add result count, navigation and clear buttons ([#234](https://github.com/kjschnei001/jaeger-ui/pull/234)), [@davit-y](https://github.com/davit-y)

##### Bug Fixes, Minor Improvements

- Use correct duration format for scatter plot ([#266](https://github.com/kjschnei001/jaeger-ui/pull/266)), [@tiffon](https://github.com/tiffon))
- Fix collapse all issues ([#264](https://github.com/kjschnei001/jaeger-ui/pull/264)), [@tiffon](https://github.com/tiffon))
- Use a moderately sized canvas for the span graph ([#257](https://github.com/kjschnei001/jaeger-ui/pull/257)), [@tiffon](https://github.com/tiffon))
...
- Compare two traces ([#228](https://github.com/kjschnei001/jaeger-ui/pull/228), [@tiffon](https://github.com/tiffon))
- Make tags clickable ([#223](https://github.com/kjschnei001/jaeger-ui/pull/223), [@divdavem](https://github.com/divdavem))
- Directed graph as React component ([#224](https://github.com/kjschnei001/jaeger-ui/pull/224), [@tiffon](https://github.com/tiffon))
- Timeline Expand and Collapse Features ([#221](https://github.com/kjschnei001/jaeger-ui/issues/221), [@davit-y](https://github.com/davit-y))
- Integrate Google Analytics into Search Page ([#220](https://github.com/kjschnei001/jaeger-ui/issues/220), [@davit-y](https://github.com/davit-y))

#### Backend Changes

##### ⛔ Breaking Changes

- `jaeger-standalone` binary has been renamed to `jaeger-all-in-one`. This change also includes package rename from `standalone` to `all-in-one` ([#1062](https://github.com/kjschnei001/jaeger/pull/1062), [@pavolloffay](https://github.com/pavolloffay))

##### New Features

- (Experimental) Allow storing tags as object fields in Elasticsearch for better Kibana support(([#1018](https://github.com/kjschnei001/jaeger/pull/1018), [@pavolloffay](https://github.com/pavolloffay))
- Enable tracing of Cassandra queries ([#1038](https://github.com/kjschnei001/jaeger/pull/1038), [@yurishkuro](https://github.com/yurishkuro))
- Make Elasticsearch index configurable ([#1009](https://github.com/kjschnei001/jaeger/pull/1009), [@pavolloffay](https://github.com/pavoloffay))
- Add flags to allow changing ports for HotROD services ([#951](https://github.com/kjschnei001/jaeger/pull/951), [@cboornaz17](https://github.com/cboornaz17))
- (Experimental) Kafka ingester ([#952](https://github.com/kjschnei001/jaeger/pull/952), [#942](https://github.com/kjschnei001/jaeger/pull/942), [#944](https://github.com/kjschnei001/jaeger/pull/944), [#940](https://github.com/kjschnei001/jaeger/pull/940), [@davit-y](https://github.com/davit-y) and [@vprithvi](https://github.com/vprithvi)))
- Use tags in agent metrics ([#950](https://github.com/kjschnei001/jaeger/pull/950), [@eundoosong](https://github.com/eundoosong))
- Add support for Cassandra reconnect interval ([#934](https://github.com/kjschnei001/jaeger/pull/934), [@nyanshak](https://github.com/nyanshak))
...
- View Trace JSON buttons return formatted JSON (fixes [#199](https://github.com/kjschnei001/jaeger-ui/issues/199))
...
- Support running Jaeger behind a reverse proxy (fixes [#42](https://github.com/kjschnei001/jaeger-ui/issues/42))
- Track Javascript errors via Google Analytics (fixes [#39](https://github.com/kjschnei001/jaeger-ui/issues/39))
- Add Google Analytics event tracking for actions in trace view ([#191](https://github.com/kjschnei001/jaeger-ui/issues/191))

##### Bug Fixes, Minor Improvements

- Clearly identify traces without a root span (fixes [#190](https://github.com/kjschnei001/jaeger-ui/issues/190))
- Fix [#166](https://github.com/kjschnei001/jaeger-ui/issues/166) JS error on search page after viewing 404 trace
...
- Use Ant Design instead of Semantic UI (https://github.com/kjschnei001/jaeger-ui/pull/169)
  - Fix [#164](https://github.com/kjschnei001/jaeger-ui/issues/164) - Use Ant Design instead of Semantic UI
  - Fix [#165](https://github.com/kjschnei001/jaeger-ui/issues/165) - Search results are shown without a date
  - Fix [#69](https://github.com/kjschnei001/jaeger-ui/issues/69) - Missing endpoints in jaeger ui dropdown

##### Bug Fixes, Minor Improvements

- Fix 2 digit lookback (12h, 24h) parsing (https://github.com/kjschnei001/jaeger-ui/issues/167)
...
- Change tag search input syntax to logfmt (https://github.com/kjschnei001/jaeger-ui/issues/145)
- Make threshold for enabling DAG view configurable (https://github.com/kjschnei001/jaeger-ui/issues/130)
- Show better error messages for failed API calls (https://github.com/kjschnei001/jaeger-ui/issues/127)
- Add View Option for raw/unadjusted trace (https://github.com/kjschnei001/jaeger-ui/issues/153)
- Add timezone tooltip to custom lookback form-field (https://github.com/kjschnei001/jaeger-ui/pull/161)

##### Bug Fixes, Minor Improvements

- Use consistent icons for logs expanded/collapsed (https://github.com/kjschnei001/jaeger-ui/issues/86)
- Encode service name in API calls to allow '/' (https://github.com/kjschnei001/jaeger-ui/issues/138)
- Fix endless trace HTTP requests (https://github.com/kjschnei001/jaeger-ui/issues/128)
- Fix JSON view when running in dev mode (https://github.com/kjschnei001/jaeger-ui/issues/139)
- Fix trace name resolution (https://github.com/kjschnei001/jaeger-ui/pull/134)
- Only JSON.parse JSON strings in tags/logs values (https://github.com/kjschnei001/jaeger-ui/pull/162)
...
- Verify stored search settings [jaegertracing/jaeger-ui#111](https://github.com/kjschnei001/jaeger-ui/pull/111)
- Fix browser back button not working correctly [jaegertracing/jaeger-ui#110](https://github.com/kjschnei001/jaeger-ui/pull/110)
- Handle FOLLOWS_FROM ref type [jaegertracing/jaeger-ui#118](https://github.com/kjschnei001/jaeger-ui/pull/118)

#### Backend Changes

- Allow embedding custom UI config in index.html [#490](https://github.com/kjschnei001/jaeger/pull/490)
- Add startTimeMillis field to JSON Spans submitted to ElasticSearch [#491](https://github.com/kjschnei001/jaeger/pull/491)
- Introduce version command and handler [#517](https://github.com/kjschnei001/jaeger/pull/517)
- Fix ElasticSearch aggregation errors when index is empty [#535](https://github.com/kjschnei001/jaeger/pull/535)
- Change package from uber to jaegertracing [#528](https://github.com/kjschnei001/jaeger/pull/528)
- Introduce logging level configuration [#514](https://github.com/kjschnei001/jaeger/pull/514)
- Support Zipkin v2 json [#518](https://github.com/kjschnei001/jaeger/pull/518)
- Add HTTP compression handler [#545](https://github.com/kjschnei001/jaeger/pull/545)
...
- Refactor trace detail [jaegertracing/jaeger-ui#53](https://github.com/kjschnei001/jaeger-ui/pull/53)
- Virtualized scrolling for trace detail view [jaegertracing/jaeger-ui#68](https://github.com/kjschnei001/jaeger-ui/pull/68)
- Mouseover expands truncated text to full length in left column in trace view [jaegertracing/jaeger-ui#71](https://github.com/kjschnei001/jaeger-ui/pull/71)
- Make left column adjustable in trace detail view [jaegertracing/jaeger-ui#74](https://github.com/kjschnei001/jaeger-ui/pull/74)
- Fix trace mini-map blurriness when < 60 spans [jaegertracing/jaeger-ui#77](https://github.com/kjschnei001/jaeger-ui/pull/77)
- Fix Google Analytics tracking [jaegertracing/jaeger-ui#81](https://github.com/kjschnei001/jaeger-ui/pull/81)
- Improve search dropdowns [jaegertracing/jaeger-ui#84](https://github.com/kjschnei001/jaeger-ui/pull/84)
- Add keyboard shortcuts and minimap UX [jaegertracing/jaeger-ui#93](https://github.com/kjschnei001/jaeger-ui/pull/93)
